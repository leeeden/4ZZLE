    ...
    <div id="container" align=center>
        <div style="width: 50%; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
                <a href="./addtvleader1.jsp"><img id="back" src="./img/back.png" style="width: 4%;"></a>
            </div>
        ...
        <div align=center style="width: 70%; padding-top: 4%;">
            ...
            <a href="./addtvleader3.jsp"><img id="next" src="./img/next.png" style="padding-bottom: 3%; width: 20%;"></a>
        </div>
    </div>
</body>
<script>
