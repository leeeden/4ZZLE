    ...
    <div id="container" align=center>
        <div style="width: 50%; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
                <a href="/puzzle/adddpleader1.jsp"><img id="back" src="/img/back.png" style="width: 4%;"></a>
            </div>
        ...
        <div align=center style="width: 70%; padding-top: 4%;">
            ...
            <button id="next" class="bigbtn" onclick = "location.href = '/puzzle/adddpleader3.jsp'">다음</button>
        </div>
    </div>
</body>
<script>
