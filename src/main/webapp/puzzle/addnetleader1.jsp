...
<body>
    <div id="container" align=center>
        ...
        <div align=center style="width: 70%; padding-top: 4%;">
            <img src="/img/addnetleader1.png" alt="" style="padding-bottom: 5%; width: 50%;">
            <img src="/img/addnetleader2.png" alt="" style="padding-bottom: 4%; width: 50%;"><br>
            <button id="next" class="bigbtn" onclick = "location.href = '/puzzle/addnetleader2.jsp'">다음</button>
        </div>
    </div>
</body>
<script>
