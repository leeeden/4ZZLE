...
<form method="post" action="/joinCheck.member" id="frm">
    <div id="container">
        <div id="header" style="padding-top: 1%;">
            ...
            <a href="./login.jsp"><div id="hright" align=center>로그인</div></a>
        </div>
        ...
        <div id="contents">
            ...
            <div id="center" style="float:left; width: 28%;">
                ...
                <input type="submit" value="회원가입" id="submit" style="width: 100%; margin-top: 5%; background-color: #7A07EE; border: none;" align=center>
                <input type="button" value="돌아가기" id="back" style="width: 100%; margin-top: 2%; background-color: #7A07EE; border: none;" align=center>
            </div>
