...
<body>
    <div id="container">
        ...
        <nav class="navbar navbar-expand navbar-light bg-light" style="padding: 0%; margin-top: 3%; margin-bottom: 4%;">
            <div class="container-fluid" style="width: 100%;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 3%;">
                    ...
                    <a class="nav-link" href="./inquiry.jsp" style="color: #EDEDED; width: 15%;">문의</a>
                </div>
            </div>
        </nav>
        <div id="notice" align=center style="color: #ededed; width: 100%; margin-bottom: 5%;">
            ...
            <a href="/write.board"><button style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #ededed; background-color: #2e2e2e; border: none; border-radius: 200px; border-radius: 200px; margin-top: 3%;">작성</button></a>
            </div>
            </c:when>
            </c:choose>
