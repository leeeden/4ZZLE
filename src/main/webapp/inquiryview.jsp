...
<body>
    <div id="container">
        ...
        <div id="notice" align=center style="color: #ededed; width: 100%; height: 80%;">
            <div id="row1"
                style="font-size : 25px; width: 70%; padding-bottom: 1%; border-bottom: 1px solid #2E2E2E; padding-left: 20px;"
                align=left>제목</div>
            <div id="row2"
                style="font-size : 12px; width: 70%; padding-bottom: 0.5%; border-bottom: 2px solid #2E2E2E; padding-left: 20px; margin-top: 0.5%;"
                align=left>작성일</div>
            <div id="row3"
                style="font-size : 15px; width: 70%; height: 600px; margin-bottom: 2%; padding-left: 35px; margin-top: 2%; border-bottom: 2px solid #2E2E2E; overflow: hidden;"
                align=left>내용입니다ㅏㅏㅏㅏ</div>
            <div id="row4" style="width: 70%; margin-bottom: 2%;" align=right>
                <button
                    style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #888888; border: 1px solid #2E2E2E; border-radius: 200px;">수정</button>
                <button
                    style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #888888; border: 1px solid #2E2E2E; border-radius: 200px; margin-left: 1%;">삭제</button>
                <button
                    style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #888888; border: 1px solid #2E2E2E; border-radius: 200px; margin-left: 1%;">목록</button>
            </div>
            <div id="row5" style="width: 70%; border-top: 2px solid #2E2E2E; border-bottom: 2px solid #2E2E2E; padding-top: 2%; padding-bottom: 16%;">
                <div style="float:left; width: 80%;">
                    <textarea name="" id="" cols="30" rows="10" style="width: 100%; color: #ededed;"></textarea>
                </div>
                <div style="float:left; width: 20%;" align=right>
                    <button style="width: 80%; height: 245px; border: 1px solid #2e2e2e; color: #888888;">등록</button>
                </div>
            </div>
        </div>
    </div>
