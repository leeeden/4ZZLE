...
<body>
    <div id="container">
        ...
        <div id="notice" align=center style="color: #ededed; width: 100%; height: 80%;">
            <div id="row1" style="font-size : 25px; width: 70%; padding-bottom: 1%; border-bottom: 2px solid #2E2E2E; padding-left: 20px;" align=left>
            ...
            <div id="row4" style="width: 70%; margin-bottom: 2%;" align=right>
                <a href="/list.board?cpage=1"><button type="button" style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #888888; border: 1px solid #2E2E2E; border-radius: 200px; margin-left: 1%;">뒤로</button></a>
                <button type="button" style="width: 10%; height: 40px; font-size: 15px; line-height: 30px; color: #ededed; background-color: #2e2e2e; border: none; border-radius: 200px; margin-left: 1%;">작성</button>
            </div>
        </div>
        </form>
    </div>
